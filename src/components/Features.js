    ...
    return (
        <section className="features" id="features">
            ...
            <div className="img-txt-bx-1">
                ...
                <div className="feature-txt-bx" style={{marginLeft:"10%"}}>                
                    ...
                    <p style={{marginTop:"10px"}}>Arcu at dictum sapien, mollis. Vulputate sit id accumsan, ultricies. In ultrices malesuada elit mauris etiam odio. Duis tristique lacus, et blandit viverra nisl velit. Sed mattis rhoncus, diam suspendisse sit nunc, gravida eu. Lectus eget eget ac dolor neque lorem sapien, suspendisse aliquam.</p>
                    
                </div>
                <div className="img-flow">
                    <img className="star-svg" style={{position:"absolute",right:"0%",marginTop:"3%"}} src={StarSvg} alt="star"/>
            ...
            <div className="img-txt-bx-1">
                ...
                <div className="feature-txt-bx" style={{marginTop:"15%"}}>                
