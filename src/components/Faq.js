...
export const Faq = () => {
    return(
        <section className="faq-section" id="faq-section" >
            <div style={{position:"absolute",left:"55%",marginTop:"5%"}}>
                <svg width="62" height="59" viewBox="0 0 62 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M31 0.70874L32.5047 30.6377L61.4338 22.8202L33.4347 33.4998L49.8091 58.5973L31 35.2687L12.1909 58.5973L28.5653 33.4998L0.566191 22.8202L29.4953 30.6377L31 0.70874Z" fill="black"/>
                </svg>


            </div>

            <div className="tagline-heading-bx">
                <h4>FAQ</h4>
            ...
            <div className="faq-cards">
                <div className="color-set">
                    ...
                    <p style={{marginTop:"10px"}}>“Arcu at dictum sapien, mollis. Vulputate sit id accumsan, ultricies. In ultrices malesuada elit mauris.</p>
                </div>
                <div className="transparent-set" style={{background:"transparent",color:"black"}}>
                    <div className="heading-card">
                        <h1>The Best Financial Accounting App Ever!</h1>
                    </div>
            ...
            <div className="card-img" style={{zIndex:"-1"}}>
                <div style={{position:"absolute",right:"30%",marginTop:"2%"}}>
                    <svg width="62" height="59" viewBox="0 0 62 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M31 0.708984L32.5047 30.6379L61.4338 22.8204L33.4347 33.5001L49.8091 58.5975L31 35.269L12.1909 58.5975L28.5653 33.5001L0.566191 22.8204L29.4953 30.6379L31 0.708984Z" fill="white"/>
                    </svg>
                </div>
                <div style={{position:"absolute",marginTop:"20%",left:"50%"}}>
                    <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M40.9117 4.67955L25.8375 21.3498L45.3253 32.5459L24.8128 23.3608L20.1867 45.3546L22.5835 23.0078L0.236642 25.4045L22.2304 20.7784L13.0454 0.265953L24.2415 19.7537L40.9117 4.67955Z" fill="white"/>
                    </svg>

                </div>

                <div className="img-stack" style={{zIndex:"100"}}>
                ...
                <div style={{position:"absolute",right:"0%",zIndex:"0"}}>
                    ...
                    <path d="M461.741 10.4564C515.082 63.7975 548.337 127.094 559.002 186.292C569.667 245.492 557.736 300.542 520.784 337.493C483.833 374.445 428.783 386.376 369.583 375.711C310.385 365.046 247.088 331.791 193.747 278.45C140.406 225.109 107.151 161.812 96.4861 102.614C85.8211 43.4145 97.7523 -11.6355 134.704 -48.5871C171.655 -85.5386 226.705 -97.4698 285.905 -86.8048C345.103 -76.1403 408.4 -42.8848 461.741 10.4564Z" stroke="white"/>
                    <path d="M493.741 -21.5436C547.082 31.7975 580.337 95.094 591.002 154.292C601.667 213.492 589.736 268.542 552.784 305.493C515.833 342.445 460.783 354.376 401.583 343.711C342.385 333.046 279.088 299.791 225.747 246.45C172.406 193.109 139.151 129.812 128.486 70.6144C117.821 11.4145 129.752 -43.6355 166.704 -80.5871C203.655 -117.539 258.705 -129.47 317.905 -118.805C377.103 -108.14 440.4 -74.8848 493.741 -21.5436Z" stroke="white"/>
                    <path d="M525.741 -53.5436C579.082 -0.202534 612.337 63.094 623.002 122.292C633.667 181.492 621.736 236.542 584.784 273.493C547.833 310.445 492.783 322.376 433.583 311.711C374.385 301.046 311.088 267.791 257.747 214.45C204.406 161.109 171.151 97.8122 160.486 38.6144C149.821 -20.5855 161.752 -75.6355 198.704 -112.587C235.655 -149.539 290.705 -161.47 349.905 -150.805C409.103 -140.14 472.4 -106.885 525.741 -53.5436Z" stroke="white"/>
                    </svg>
                </div>
                <div className="ellipse" style={{position:"absolute",zIndex:"0"}}>
                    <svg width="300" height="225" viewBox="0 0 300 225" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M133.741 166.456C187.082 219.797 220.337 283.094 231.002 342.292C241.667 401.492 229.736 456.542 192.784 493.493C155.833 530.445 100.783 542.376 41.5826 531.711C-17.6151 521.046 -80.9116 487.791 -134.253 434.45C-187.594 381.109 -220.849 317.812 -231.514 258.614C-242.179 199.414 -230.248 144.364 -193.296 107.413C-156.345 70.4614 -101.295 58.5302 -42.0947 69.1952C17.1031 79.8597 80.3996 113.115 133.741 166.456Z" stroke="white"/>
                    <path d="M165.741 134.456C219.082 187.797 252.337 251.094 263.002 310.292C273.667 369.492 261.736 424.542 224.784 461.493C187.833 498.445 132.783 510.376 73.5826 499.711C14.3849 489.046 -48.9116 455.791 -102.253 402.45C-155.594 349.109 -188.849 285.812 -199.514 226.614C-210.179 167.414 -198.248 112.364 -161.296 75.4129C-124.345 38.4614 -69.2946 26.5302 -10.0947 37.1952C49.1031 47.8597 112.4 81.1152 165.741 134.456Z" stroke="white"/>
                    <path d="M197.741 102.456C251.082 155.797 284.337 219.094 295.002 278.292C305.667 337.492 293.736 392.542 256.784 429.493C219.833 466.445 164.783 478.376 105.583 467.711C46.3849 457.046 -16.9116 423.791 -70.2527 370.45C-123.594 317.109 -156.849 253.812 -167.514 194.614C-178.179 135.414 -166.248 80.3645 -129.296 43.4129C-92.3446 6.46138 -37.2946 -5.46977 21.9053 5.19516C81.1031 15.8597 144.4 49.1152 197.741 102.456Z" stroke="white"/>
                    </svg>
                </div>
                ...
                <div style={{display:"flex"}}>
                    <button className="btn-apple" style={{zIndex:"100"}}>
                        Download App
                        <span style={{marginLeft:"10px"}}><svg width="26" height="33" viewBox="0 0 26 33" fill="none" xmlns="http://www.w3.org/2000/svg">
