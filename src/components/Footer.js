            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="mb-6 md:mb-0">
                        <h1 className="text-black" style={{fontSize:"32px",fontFamily:"Clash Display Med",fontWeight:"500"}}>Links</h1>
                        <div className="mt-3" style={{display:"flex"}}>
                    ...
                    <div className="mb-6 md:mb-0">
                        <h1 className="text-black" style={{fontSize:"32px",fontFamily:"Clash Display Med",fontWeight:"500"}}>Legal</h1>
                        <div className="mt-3" style={{display:"flex"}}>
                    ...
                    <div className="mb-6 md:mb-0">
                        <h1 className="text-black" style={{fontSize:"32px",fontFamily:"Clash Display Med",fontWeight:"500"}}>Product</h1>
                        <div className="mt-3" style={{display:"flex"}}>
                    ...
                    <div className="mb-6 md:mb-0">
                        <h1 className="text-black" style={{fontSize:"32px",fontFamily:"Clash Display Med",fontWeight:"500"}}>Newsletter</h1>
                        <div className="mt-3" style={{display:"flex"}}>
                        ...
                        <div className="mt-3" style={{display:"flex",marginTop:"20px"}}>
                            <input className="input-bx" type="text" placeholder="Your Email" required/>
